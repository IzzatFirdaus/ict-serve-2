...
<body>
    ...
    <!--[if BLOCK]><![endif]--><?php if(isset($exceptionAsMarkdown)): ?>
        <div><?php echo $exceptionAsMarkdown; ?></div>
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
    <pre><?php echo e(print_r($exception, true)); ?></pre>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\ict-serve-2\resources\views/vendor/laravel-exceptions-renderer/show.blade.php ENDPATH**/ ?>