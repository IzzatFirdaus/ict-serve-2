    ...
    */
    ...
    'colors' => [
        'primary' => [
            ...
            'dark' => '#6394FF', // primary-400
        ],
        'success' => [
            'light' => '#22C55E', // success-500
            'dark' => '#4ADE80', // success-400
        ],
        'danger' => [
            'light' => '#EF4444', // danger-500
            'dark' => '#F87171', // danger-400
        ],
        'warning' => [
            'light' => '#EAB308', // warning-500
            'dark' => '#FACC15', // warning-400
        ],
        'background' => [
            'light' => '#FFFFFF', // bg-white
            'dark' => '#18181B', // bg-white (dark mode)
        ],
    ],
