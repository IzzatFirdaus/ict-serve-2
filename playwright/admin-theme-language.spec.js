...
test.describe('Admin Panel: Theme & Language Switching', () => {
  ...
  test.beforeEach(async ({ page }) => {
    ...
    await expect(
      page.getByRole('heading', { name: /Dashboard|Papan Pemuka/ })
    ).toBeVisible();
  });

  test('allows a user to switch themes and verifies the change', async ({
    page,
  }) => {
  ...
  test('allows a user to switch the language and verifies the UI updates', async ({
    page,
  }) => {
